...
class Kanye { constructor(scene, i, texture, speed, isMobile) {
    this.isMobile = isMobile;
    this.farWall = -150;
    this.closeWall = 150;
    this.speed = speed;
    let size = (this.isMobile) ? 12 : 8;
    var geometry = new CircleGeometry(size, 50);
	  var material = new MeshBasicMaterial({ map: texture, transparent: true });
    this.cube = new Mesh(geometry, material);
	  this.cube.position.set(this._getRandomInt(-100, 100), 
